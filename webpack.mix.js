...
mix
  ...
  .sass('resources/assets/scss/profit-page.scss', 'public/css/custom', { sassOptions })
mix.js('./resources/assets/js/app.js', 'public/js/app.js');
mix.copy('./resources/assets/js/profit-page.js', 'public/js/custom/profit-page.js');
mix.copy('./resources/assets/js/init.js', 'public/js/init.js');
mix.copy('./resources/assets/js/jquery.fullscreen-min.js', 'public/js/jquery.fullscreen-min.js');
